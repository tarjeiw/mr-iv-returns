...
# 2. For Howe et al within family GWAS #####
# Also use the same SNPs that we used to create the allele score in One sample MR
...
# --fastGWA-mlm \
# --bfile /tsd/p805/cluster/data/genetics/MoBaPsychGen_v1/MoBaPsychGen_v1-ec-eur-batch-basic-qc \
# --grm-sparse /tsd/p805/cluster/data/genetics/GRM/MoBaPsychGen_v1_HapMap3Plus \
# --pheno income.gcta \
# --qcovar 20PCS_yob.qcov \
# --covar ${covariate}/sex_batches.cov \
# --est-vg HE \
# --threads 10 \
# --extract instruments.txt \
# --out gwas_mr_income
...
# 4. Check  this GWAS based on 335 SNPs ######
hist(income_gwas$P)
hist(income_gwas$BETA)


# # Load individuals Genetic ID passing Qcs (created by Perline) to double check sample 
# load("N:/durable/projects/Perline/2024_family_relationships/individual_Ids.rda")
# 
# income_data_sentrix <- merge(individual, outcome, by= "w19_0634_lnr")
# about 140 less individuals fro some reasons 